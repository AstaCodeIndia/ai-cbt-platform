...
const Login: React.FC = () => {
  ...
  const handleDemoLogin = (role: 'admin' | 'student') => {
    ...
    localStorage.setItem('user', JSON.stringify({
      id: 'demo-user',
      username: role === 'admin' ? 'Admin User' : 'Student User',
      email: `${role}@demo.com`,
      role: role,
    }));
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mt-6 p-4 bg-muted/50 rounded-lg border border-border">
            <p className="text-sm text-muted-foreground mb-3 text-center">Demo Access</p>
      ...
      {/* Right Side - Visual */}
      <div className="hidden lg:flex flex-1 items-center justify-center p-8 bg-gradient-to-br from-primary via-primary-light to-accent relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-40 h-40 rounded-full bg-white blur-3xl" />
          <div className="absolute bottom-20 right-20 w-60 h-60 rounded-full bg-white blur-3xl" />
        </div>
        ...
        >
          ...
          <h2 className="text-4xl font-bold mb-4">AI-Powered CBT Platform</h2>
          <p className="text-xl opacity-90 mb-8">
            Create, manage, and take tests with cutting-edge AI assistance. 
            NTA-style interface for authentic exam preparation.
          </p>
